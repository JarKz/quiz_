...
public class QuestionManagement {
    ...
    public String reloadPage(
    	...
    	return "redirect:/" + TemplateNames.QUIZ.getTemplateName();
    }
    ...
    public String createQuestionAndReturnNewPage(
            ...
            @RequestParam(name = "right-answer") String rightAnswer,
            @RequestParam(name = "wrong-answers") List<String> wrongAnswers,
            Authentication auth
    ){
    	Quiz quiz = quizRepo.getQuizWithUserById(quizId);
    	if (quiz.getUser() != null && quiz.getUser().getNickname().equals(auth.getName())) {
	        ...
	        quizRepo.save(quiz);
	        return String.format("redirect:/%s?quiz_id=%d", TemplateNames.QUESTION_MANAGEMENT.getTemplateName(), quizId);
    	}
    	return "redirect:/" + TemplateNames.QUIZ.getTemplateName();
    }
